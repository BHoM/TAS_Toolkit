...
namespace BH.Adapter.TAS
{
    public partial class TasT3DAdapter : BHoMAdapter
    {
        ...
        private List<Space> ReadSpaces(List<string> ids = null)
        {
            ...
            {
                TAS3D.Zone zone = t3dDocument.Building.GetZone(zoneIndex);
                spaces.Add(Engine.TAS.Convert.ToBHoM(zone, t3dDocument));
                zoneIndex++;
            }
        ...
        //{
        //    TAS3D.Building t3dBuilding = t3dDocument.Building;
        //    List<BH.oM.Architecture.Elements.Level> levels = new List<BH.oM.Architecture.Elements.Level>();
        //    levels = Engine.TAS.Convert.ToBHoMLevels(t3dBuilding);
        ...
        //    int zoneIndex = 0;
        //    while (t3dDocument.Building.GetZone(zoneIndex) != null)
        //    {
        //        int panelIndex = 0;
        //        while (t3dDocument.Building.GetZone(zoneIndex).GetSurface(panelIndex) != null)
        //        {
        //            TBD.zoneSurface zonesurface = t3dDocument.Building.GetZone(zoneIndex).GetSurface(panelIndex);

        //            int roomSurfaceIndex = 0;
        //            while (zonesurface.GetRoomSurface(roomSurfaceIndex) != null)
        //            {
        //                TAS3D.RoomSurface currRoomSrf = zonesurface.GetRoomSurface(roomSurfaceIndex);
        ...
        //        TAS3D.zoneSurface zoneSrf = null;
        ...
        //public List<BH.oM.Physical.Constructions.Construction> ReadConstruction(List<string> ids = null)
        //{
        //    TAS3D.Building building = t3dDocument.Building;
        //    List<BH.oM.Physical.Constructions.Construction> constructions = new List<BH.oM.Physical.Constructions.Construction>();

        //    int buildingElementIndex = 0;
        //    while (building.GetConstruction(buildingElementIndex) != null)
        //    {
        //        TAS3D.Construction construction = t3dDocument.Building.GetConstruction(buildingElementIndex);
        ...
        //    {
        //        TAS3D.InternalCondition internalCondition = t3dDocument.Building.GetIC(internalConditionIndex);
        ...
        //{
        //    TAS3D.BuildingStorey t3dStorey = m_T3DDocumentInstance.Building.GetStorey(0);
        //    List<BHS.Elements.Storey> storey = new List<BHS.Elements.Storey>();
        //    storey.Add(Engine.TAS.Convert.ToBHoM(t3dStorey));
        ...
        //private List<BH.oM.Physical.Constructions.Layer> ReadMaterials(List<string> ids = null)
        //{
        //    TAS3D.Building building = t3dDocument.Building;

        //    List<BH.oM.Physical.Constructions.Layer> material = new List<BH.oM.Physical.Constructions.Layer>();

        //    int constructionIndex = 0;
        //    while (building.GetConstruction(constructionIndex) != null)
        //    {

        //        TAS3D.Construction currConstruction = building.GetConstruction(constructionIndex);
        ...
        //        {
        //            TAS3D.material t3dMaterial = building.GetConstruction(constructionIndex).materials(materialIndex);

        //            material.Add(Engine.TAS.Convert.ToBHoM(t3dMaterial, currConstruction));
        //            materialIndex++;
        //        }
