...
namespace TAS_Test.Engine.Convert
{
    ...
    public class ToTAS_Building
    {
        ...
        {
            ////Determines whether a Building created by ToTAS has it's given name and location.   
            //string buildingName = "TestBuildingName";
            //TBD.Building tbdBuilding = new TBD.Building();
            //tbdBuilding.name = buildingName;
            //Assert.IsTrue(tbdBuilding.name.Equals(buildingName));
